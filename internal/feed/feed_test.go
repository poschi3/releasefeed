...
func TestMediawiki_1_39(t *testing.T) {
	...
	assert.Equal(t, "tag:localhost,2025-06-30:mediawiki:1.39.13", feed.Id) // TODO
	...
	assert.Equal(t, "mediawiki  updated to 1.39.13 (2025-06-30). Support until 2025-12-31", feed.Entries[0].Summary) // TODO
}
